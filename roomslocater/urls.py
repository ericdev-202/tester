"""roomslocater URL Configuration
...
urlpatterns = [
    ...
    path('sent/', r_views.activation_sent_view, name="activation_sent"),
    path('activate/<slug:uidb64>/<slug:token>/', r_views.activate, name='activate'),
